...
#define MATRIX_COL_PINS { D7, E0, E1, C0, C1, C2, C3, C4, C6, F6, F4, F3, F2, F1, F0, E7, B0, B1, B2, B3 }
#define MATRIX_ROW_PINS { B7, D0, D1, D2, D3, D4, D5, D6, C7, F7, F5, E6 }
...
// Enable TAPPING_TERM for soft mode switching (see options in rules.mk and keymap.c)
