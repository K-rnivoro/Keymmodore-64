...
#define C64       5   /* Commodore 64 and VIC-20 layout for Bare Metal Commodore, Combian, VICE or CCS64 Emulators. Remember to set "Keyboard Settings" in "Positional" Layout in Emulator (maybe PET compatible too)*/
#define C16       6   /* Commodore Plus/4, C16 and C116 layout for Bare Metal Commodore, Combian or VICE Emulators. Remember to set "Keyboard Settings" in "Positional" Layout in Emulator */
...
//Inverted Logic so PinLow is On and PinHigh is Off.
