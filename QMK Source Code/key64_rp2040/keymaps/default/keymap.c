...
#define C64_CBM          5   /* Commodore Key pressed in C-64 Mode. Allows to go back to PC Mode pressing CONTROL. */
#define C128         6   /* Commodore 128 Keyboard mapping. (need custom .vkm for emulators) */
#define C128_RSFT    7   /* Commodore 128 Keyboard with Right Shift pressed mapping (allow to access exclusive C-128 Keys). */
#define C128_CBM     8   /* Commodore 128 Keyboard with Commodore key pressed mapping (allow to access Down and Right Cursor C-128 exclusive keys). */
#define PETBUS       9   /* Commodore PET Business Keyboard mapping (upper case letters with SHIFT key). */
#define PETBUS_C     10  /* Commodore PET Business Keyboard mapping with C= Key. Allows access to NumPad keys. */
#define PETGRAPH     11  /* Commodore PET Graphics Keyboard mapping. Allows access right legend PETSCII with SHIFT key. */
#define PETGRAPH_C   12  /* Commodore PET Graphics Keyboard mapping with C= Key. Allow access left legend PETSCII codes with C= key. */
...
[RSHFT] = LAYOUT(
	    ...
	    KC_PIPE,  			____,                	KC_RBRC,      				KC_QUES,           		____,              		____,                	S(KC_NUBS),			S(KC_HOME),		____,
		S(KC_DEL),			S(KC_ENT),           	KC_LEFT,       				KC_UP,             		KC_F2,            		KC_F4,    	     	    KC_F6,    			KC_F8,      	____,
		____, 				____,            		____,      					____,    	      		____,																				S(KC_BSPC)
		),

[CKEY] = LAYOUT(
        KC_F1,  			KC_GRV,              	KC_LCTL,      				KC_LGUI,          		____,		     		____,                	____,   			KC_F2,
        KC_F3,   			KC_UP,     				KC_LEFT,       				____,              		____,           		KC_DOWN,             	____,   			KC_F4,
        KC_F5,   			____,                	KC_RGHT,       				____,              		KC_CALC,           		____,                	____,      			KC_F6,
		KC_F7,   			____,                	____,          				____,           		____,          			____,                	____,   			KC_F8,    		____,
		KC_F9,   			KC_UP,               	KC_LEFT,       				KC_NUM,           		____,           		KC_DOWN,             	____,   			KC_F10,   		____,
		KC_F11,  			KC_PSCR,             	KC_RGHT,       				KC_VOLD,           		KC_VOLU,           		KC_LCBR,             	KC_SCRL,   			KC_F12,   		____,
		____,    			KC_PAUS,           		KC_RCBR,       				KC_MUTE,           		____,              		____,                	KC_PGUP,   			KC_END,   		____,
		KC_INS,  			____,                	KC_LEFT,       				KC_UP,             		TO(C64),            	TO(C128),             	TO(PETGRAPH),		____,       	____,
		____,     			____,                	____,          				____,              		____, 																				KC_PGDN
		),

[C64] = LAYOUT(
        KC_1,     			KC_GRV,             	KC_TAB,       				KC_ESC,             	KC_SPC,     	       	LM(C64_CBM,MOD_LCTL),  	KC_Q,    			KC_2,
...
[C128] = LAYOUT(
        KC_1,     			KC_GRV,             	KC_TAB,   		      		KC_ESC,             	KC_SPC,     	       	LM(C128_CBM,MOD_LCTL), 	KC_Q,    			KC_2,
        KC_3,     			KC_W,               	KC_A,         				KC_LSFT,            	KC_Z,      	        	KC_S,                	KC_E,    			KC_4,
        KC_5,     			KC_R,               	KC_D,         				KC_X,               	KC_C,              		KC_F,                	KC_T,    			KC_6,
		KC_7,     			KC_Y,               	KC_G,         				KC_V,               	KC_B,              		KC_H,                	KC_U,    			KC_8,        	KC_P7,
		KC_9,     			KC_I,               	KC_J,         				KC_N,               	KC_M,              		KC_K,                	KC_O,    			KC_0,        	KC_P3,
...
[C128_CBM] = LAYOUT(
		...
		____,    			____,                	____,          				____,              		____,              		____,                   ____,    			____,    		____,
		____,    			____,                	____,          				____,              		____,              		____,                   ____,    			____,    		____,
		____,    			____,                	KC_END,          			KC_PGDN,           		____,              		____,                   ____,    			____,           ____,
		____,				____,                	____,          				____,              		____,																				____
		),
